...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('PYTHIA6_exclLambdaBtoJpsiMuMu_7TeV_cff_py_GEN_SIM_DIGI_L1_DIGI2RAW.root')
)
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('PYTHIA6_exclLambdaBtoJpsiMuMu_7TeV_cff_py_GEN_SIM_DIGI_L1_DIGI2RAW.root nevts:1'),
...
#eventAutoFlushCompressedSize = cms.untracked.int32(5242880),
    ...
    fileName = cms.untracked.string('PYTHIA6_exclLambdaBtoJpsiMuMu_7TeV_cff_py_GEN_SIM_DIGI_L1_DIGI2RAW_root_HLT_quarkoniumRAW2DIGI_L1Reco_RECO.root'),

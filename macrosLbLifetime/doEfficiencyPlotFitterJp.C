...
void doEfficiencyPlotFitterJp(TTree *tree, const string &title, const string &titleObs, const string &titleUnitObs,
	const string &binVar, const std::vector<double> &bins, const string &cut, const string &cutPass, const string &cutFail, Canvaspager &cp, HtmlReport *htrep)
{
    ...
    vector<doMassFitJp01_fitresults> resFull, resPass, resFail;
	...
	cp.cdNext();
	doMassFitJp01_fitresults res = doMassFitJp01(subtree, 0, curTitle, false, false, false, "mass");
